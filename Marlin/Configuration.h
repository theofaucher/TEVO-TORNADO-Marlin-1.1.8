...
#define STRING_CONFIG_H_AUTHOR "(Theo FAUCHER, TEVO TORNADO)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 " " // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "1.1.8"         // will be shown during bootup in line 2
...
//Ajout Jérôme pour prise en charge de mon afficheur
